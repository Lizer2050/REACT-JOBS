...
const JobListings = ({isHome = false}) => {
  ...
  // useEffect allows you to perform side effects on your component
  ...
  // dependency array: when the value of the value in it changes the useEffet will run. It loops through array, if there is a value in it, there will be a never ending loop
  useEffect (() => {
