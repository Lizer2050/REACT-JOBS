...
const JobListing = ({job}) => {
    // Setting the state
    //showFullDescription: name of state
    //setShowFullDescription]: name of function of the state, and describes the new state of the function.
  ...
  return (
    <div className="bg-white rounded-xl shadow-md relative">
                <div className="p-4">
                    ...
                    {/* Creating a toggle by using a button, and creating an event using onclick */}
